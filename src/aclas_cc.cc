...
extern "C" {
	...
	typedef void (WINAPI* FP)(UINT32 Errorcode, UINT32 index, UINT32 Total, NapiCall* call); // 最后一位形参会传给 onprogress
	typedef HANDLE (CALLBACK* pAclasSDKExecTask)(UINT32 Addr, UINT32 Port, UINT32 ProtocolType, UINT32 ProceType, UINT32 DataType, char* FileName, FP fp, NapiCall* call); // 最后一位形参会传给 onprogress
